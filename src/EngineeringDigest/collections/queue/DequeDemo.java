...
//Deque is a versatile data structure that combines both Queue (FIFO) and Stack (LIFO)
...
// Definition:
// Allows insertion and removal from BOTH ends (front + rear)
...
// addLast(e)
// offerFirst(e) → returns false if fails
// offerLast(e)
