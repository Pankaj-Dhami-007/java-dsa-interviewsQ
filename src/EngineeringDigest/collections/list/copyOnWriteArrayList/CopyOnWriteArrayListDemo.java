package EngineeringDigest.collections.list.copyOnWriteArrayList;
...
public class CopyOnWriteArrayListDemo {
    ...
    // notepad --> notepad-copy   notes read multiple user
    // use -> read more , write less
    public static void main(String[] args) {

        CopyOnWriteArrayList<Integer> list = new CopyOnWriteArrayList<>();
        List<String> shoppingList = new CopyOnWriteArrayList<>();// read and write
